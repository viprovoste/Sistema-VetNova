...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleStockNoDisponible(StockNoDisponibleException ex) {
        return construir(HttpStatus.CONFLICT, ex.getMessage(), null);
    }

    @ExceptionHandler(VentaYaProcesadaException.class)
    public ResponseEntity<ErrorResponse> handleVentaYaProcesada(VentaYaProcesadaException ex) {
        return construir(HttpStatus.CONFLICT, ex.getMessage(), null);
    }
